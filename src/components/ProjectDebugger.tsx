  ...
  return (
    <Card className="p-6 mb-6 border-2 border-red-500">
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Zeigt Projekte aus GET /projects (aktive, nicht gelöschte). Zum Wiederherstellen
        gelöschter Einträge die Appwrite-Konsole oder einen direkten API-Pfad mit Projekt-ID nutzen.
      </p>
            ...
            return (
              <div
                ...
                className={`p-3 rounded border ${
                  deleted ? 'bg-red-50 border-red-300' : 'bg-green-50 border-green-300'
                }`}
              >
